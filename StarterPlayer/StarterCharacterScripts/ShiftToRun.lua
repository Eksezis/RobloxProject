...
local function Run()
	if RunConfig.Walking and RunConfig.CanRun and not RunConfig.Crouching and not RunConfig.Sliding then
...
local function Sprint()
	if RunConfig.Walking and RunConfig.Running and RunConfig.CanSprint and not RunConfig.Crouching and not RunConfig.Sliding then
